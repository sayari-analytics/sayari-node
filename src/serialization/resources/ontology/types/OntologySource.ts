...
export const OntologySource: core.serialization.ObjectSchema<serializers.OntologySource.Raw, Sayari.OntologySource> =
...
export declare namespace OntologySource {
