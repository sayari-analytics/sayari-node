...
export class ProjectEntity {
     ...
     *
     * @param {string} projectId
     * @param {Sayari.GetProjectRiskChangesRequest} request
     * @param {ProjectEntity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Sayari.BadRequest}
     * @throws {@link Sayari.Unauthorized}
     ...
     */
    public async getProjectRiskChanges(
        projectId: string,
        request: Sayari.GetProjectRiskChangesRequest = {},
        requestOptions?: ProjectEntity.RequestOptions,
    ): Promise<Sayari.ProjectRiskChangesResponse> {
        const { limit, next, prev, sortDate, filterFrom, filterTo, filterRiskFactor, filterRiskCategory } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        if (limit != null) {
            _queryParams["limit"] = limit.toString();
        }
        ...
        if (sortDate != null) {
            _queryParams["sort.date"] = serializers.SortOrder.jsonOrThrow(sortDate, {
                unrecognizedObjectKeys: "strip",
            });
        }

        if (filterFrom != null) {
            _queryParams["filter.from"] = filterFrom;
        }

        if (filterTo != null) {
            _queryParams["filter.to"] = filterTo;
        }

        if (filterRiskFactor != null) {
            _queryParams["filter.risk_factor"] = toJson(filterRiskFactor);
        }

        if (filterRiskCategory != null) {
            _queryParams["filter.risk_category"] = toJson(filterRiskCategory);
        }
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SayariEnvironment.Production,
                `/v1/projects/${encodeURIComponent(projectId)}/entities/changes/risk`,
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return serializers.ProjectRiskChangesResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SayariTimeoutError(
                    "Timeout exceeded when calling GET /v1/projects/{project_id}/entities/changes/risk.",
                );
            case "unknown":
                throw new errors.SayariError({
                    message: _response.error.errorMessage,
     ...
     * @param {string} projectId
     * @param {string} projectEntityId
     * @param {Sayari.GetProjectEntityRiskChangesRequest} request
     * @param {ProjectEntity.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Sayari.BadRequest}
     * @throws {@link Sayari.Unauthorized}
     ...
     */
    public async getProjectEntityRiskChanges(
        projectId: string,
        projectEntityId: string,
        request: Sayari.GetProjectEntityRiskChangesRequest = {},
        requestOptions?: ProjectEntity.RequestOptions,
    ): Promise<Sayari.ProjectEntityRiskChangesResponse> {
        const { limit, next, prev, sortDate, filterFrom, filterTo, filterRiskFactor, filterRiskCategory } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        if (limit != null) {
            _queryParams["limit"] = limit.toString();
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SayariEnvironment.Production,
                `/v1/projects/${encodeURIComponent(projectId)}/entities/${encodeURIComponent(projectEntityId)}/changes/risk`,
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return serializers.ProjectEntityRiskChangesResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                breadcrumbsPrefix: ["response"],
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SayariTimeoutError(
                    "Timeout exceeded when calling GET /v1/projects/{project_id}/entities/{project_entity_id}/changes/risk.",
                );
            case "unknown":
                throw new errors.SayariError({
                    message: _response.error.errorMessage,
     ...
     */
    public async deleteProjectRiskChanges(
        projectId: string,
        requestOptions?: ProjectEntity.RequestOptions,
    ): Promise<void> {
        const _response = await core.fetcher({
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SayariTimeoutError(
                    "Timeout exceeded when calling DELETE /v1/projects/{project_id}/entities/changes/risk.",
                );
            case "unknown":
                throw new errors.SayariError({
                    message: _response.error.errorMessage,
     ...
     */
    public async deleteProjectEntityRiskChanges(
        projectId: string,
        projectEntityId: string,
        requestOptions?: ProjectEntity.RequestOptions,
    ): Promise<void> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SayariTimeoutError(
                    "Timeout exceeded when calling DELETE /v1/projects/{project_id}/entities/{project_entity_id}/changes/risk.",
                );
            case "unknown":
                throw new errors.SayariError({
                    message: _response.error.errorMessage,
