...
export class Screen {
    constructor(protected readonly _options: Screen.Options = {}) {}

    /**
     * Screen a project entity against watchlist records to identify potential matches. Requires the `screened_risk` role.
     *
     * @param {string} projectId - Project identifier.
     * @param {string} projectEntityId - Project entity identifier.
     * @param {Sayari.ScreenRequest} request
     * @param {Screen.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async screen(
        ...
        const { type: type_, releaseName } = request;
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `/v1/projects/${encodeURIComponent(projectId)}/entities/${encodeURIComponent(projectEntityId)}/screen`,
            ),
            method: "GET",
            headers: {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.SayariTimeoutError(
                    "Timeout exceeded when calling GET /v1/projects/{project_id}/entities/{project_entity_id}/screen.",
                );
            case "unknown":
                throw new errors.SayariError({
