...
export interface EmbeddedEntity {
    ...
    dateOfBirth?: string;
    relationshipCount: SayariAnalyticsApi.RelationshipCount;
    userRelationshipCount: SayariAnalyticsApi.RelationshipCount;
    /** Count of attributes for a given [attribute type](/sayari-library/ontology/attributes) */
    attributeCount: Record<SayariAnalyticsApi.Attributes, number | undefined>;
    /** Count of user-created attributes for a given [attribute type](/sayari-library/ontology/attributes) */
    userAttributeCount: Record<SayariAnalyticsApi.Attributes, number | undefined>;
