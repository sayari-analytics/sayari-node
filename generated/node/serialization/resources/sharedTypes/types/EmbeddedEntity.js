...
export const EmbeddedEntity = core.serialization.object({
    ...
    relationshipCount: core.serialization.property("relationship_count", core.serialization.record(core.serialization.lazy(() => __awaiter(void 0, void 0, void 0, function* () { return (yield import("../../..")).Relationships; })), core.serialization.number().optional())),
});
