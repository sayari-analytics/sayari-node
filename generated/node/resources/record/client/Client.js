    ...
    getRecord(id, request = {}, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (referencesLimit != null) {
                _queryParams.append("references.limit", referencesLimit.toString());
            }
            if (referencesOffset != null) {
                _queryParams.append("references.offset", referencesOffset.toString());
            }
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.SayariAnalyticsApiEnvironment.Production, `/v1/record/${yield serializers.RecordId.jsonOrThrow(id)}`),
                method: "GET",
                headers: {
            ...
            if (_response.ok) {
                return yield serializers.RecordDetails.parseOrThrow(_response.body, {
