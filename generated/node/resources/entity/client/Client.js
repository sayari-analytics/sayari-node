...
class Entity {
    ...
    getEntity(id, request = {}, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.SayariAnalyticsApiEnvironment.Production, `/v1/entity/${yield serializers.EntityId.jsonOrThrow(id)}`),
                method: "GET",
                headers: {
    ...
    entitySummary(id, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.SayariAnalyticsApiEnvironment.Production, `/v1/entity_summary/${yield serializers.EntityId.jsonOrThrow(id)}`),
                method: "GET",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    client: yield core.Supplier.get(this._options.client),
