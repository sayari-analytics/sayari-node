...
exports.TraversalResponse = void 0;
...
exports.TraversalResponse = core.serialization.object({
    ...
    relationships: core.serialization.list(core.serialization.string()),
    ...
    data: core.serialization.list(core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../../..")))).TraversalData; }))),
