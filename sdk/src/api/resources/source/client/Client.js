...
export class Source {
    ...
    listSources(request = {}, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: urlJoin((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.SayariAnalyticsApiEnvironment.Production, "/v1/sources"),
                method: "GET",
                headers: {
    ...
    getSource(id, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: urlJoin((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.SayariAnalyticsApiEnvironment.Production, `/v1/source/${yield serializers.SourceId.jsonOrThrow(id)}`),
                method: "GET",
                headers: {
                    Authorization: yield this._getAuthorizationHeader(),
                    "client-name": yield core.Supplier.get(this._options.clientName),
